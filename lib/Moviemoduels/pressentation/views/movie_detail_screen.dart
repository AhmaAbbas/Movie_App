...
import 'package:movies/Moviemoduels/pressentation/maneger/moviedetail_bloc/moviedetail_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      create: (context) => MovieDetailsBloc(
          getMovieDetails_USeCase: getit<GetMovieDetails_USeCase>(),
          getRecommedationMovieUsecase: getit<GetRecommedationMovieUsecase>())
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
       if(state.moviedetailstate==RequestStates.isloading){
                   ...
                   child: Padding(
                     ...
                     child: Column(
                       ...
                       children: [
                         ...
                         Row(
                           children: [
                             Container(
                               ...
                               child: Text(
                                 state.movieDetailsModel!.relasedate.split('-')[0],
                             ...
                             Row(
                               children: [
                                 ...
                                 Text(
                                   (state.movieDetailsModel!.voteAverage / 2)
                                       .toStringAsFixed(1),
                                   style: const TextStyle(
                                     fontSize: 16.0,
                                     fontWeight: FontWeight.w500,
                             ...
                             Text(
                               _showDuration(
                                   state.movieDetailsModel!.runtime.toInt()),
                               style: const TextStyle(
                         ...
                         const SizedBox(height: 8.0),
                         Text(
                           'Genres: ${_showGenres(state.movieDetailsModel!.generes)}',
                           style: const TextStyle(
                             color: Colors.white70,
                             fontSize: 12.0,
                             fontWeight: FontWeight.w500,
          ...
          delegate: SliverChildBuilderDelegate(
              ...
              return FadeInUp(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: AppConstants.imgeurl(state.recommendations[index]!.backdropPath!),
